...
class Dealer:
    ...
    def get_filters(self, req):
        condition = dict()
        for key, field in {"kb_ids": "kb_id", "doc_ids": "doc_id", "sub_doc_ids": "sub_doc_id"}.items():
            if key in req and req[key] is not None:
                condition[field] = req[key]
        # TODO(yzc): `available_int` is nullable however infinity doesn't support nullable columns.
        for key in ["knowledge_graph_kwd", "available_int", "entity_kwd", "from_entity_kwd", "to_entity_kwd",
                    "removed_kwd", "doc_type_kwd", "sub_doc_type_kwd"]:
            if key in req and req[key] is not None:
        ...
        if "sub_doc_type" in req and req["sub_doc_type"] is not None:
            condition["sub_doc_type_kwd"] = req["sub_doc_type"]
        return condition
    ...
    async def search(self, req, idx_names: str | list[str],
        ...
        src = req.get("fields",
                      ["docnm_kwd", "content_ltks", "kb_id", "img_id", "title_tks", "important_kwd", "position_int",
                       ...
                       "block_refs", "bbox_union", "sub_doc_id", "sub_doc_type_kwd", "sub_doc_page_range"])
        kwds = set([])
    ...
    async def retrieval(
        ...
        for i in page_idx:
            ...
            d = {
                ...
                "sub_doc_id": chunk.get("sub_doc_id", ""),
                "sub_doc_type": chunk.get("sub_doc_type_kwd", ""),
                "sub_doc_page_range": chunk.get("sub_doc_page_range", []),
            }
