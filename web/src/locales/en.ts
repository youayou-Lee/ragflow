...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      fullReparse: 'Full Reparse',
      fullReparseDesc: 'Re-run OCR and re-parse document',
      textOnlyReparse: 'Text-Only Reparse',
      textOnlyReparseDesc: 'Use OCR cache, skip OCR API call',
